...
<div class="modal fade" tabindex="-1" role="dialog" id="stockModal">
    ...
    <script src="${pageContext.request.contextPath}/plugins/jquery-inputmask/jquery.inputmask.bundle.js"></script>

    <!-- Multi Select Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/multi-select/js/jquery.multi-select.js"></script>

    <!-- Jquery Spinner Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/jquery-spinner/js/jquery.spinner.js"></script>

    <!-- Bootstrap Tags Input Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>

    <!-- noUISlider Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/nouislider/nouislider.js"></script>
    <!-- Autosize Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/autosize/autosize.js"></script>

    <!-- Moment Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/momentjs/moment.js"></script>

    <script src="${pageContext.request.contextPath}/js/customescripts/footer.js"></script>

    <!-- Jquery Validation Plugin Css -->
    <script src="${pageContext.request.contextPath}/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Editable Table Plugin Js -->
    <script src="${pageContext.request.contextPath}/plugins/editable-table/mindmup-editabletable.js"></script>

    <!-- date-range-picker -->
    <script src="${pageContext.request.contextPath}/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
    <!-- bootstrap datepicker -->
    <script src="${pageContext.request.contextPath}/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
